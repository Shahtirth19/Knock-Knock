...
public class Workers extends Fragment {
    ...
    private ArrayList<String> workerList = new ArrayList<>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        listView = root.findViewById(R.id.worker_list);
        initializeListView();
        return root;
    }
    ...
    private void initializeListView() {
        ...
        final ArrayAdapter<String> adapter = new ArrayAdapter<String>(getActivity(), android.R.layout.simple_list_item_1,workerList);
...
//        Query data = reference.orderByChild("id").equalTo("user");
        reference.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                ...
                String number = snapshot.child("phno").getValue(String.class);
